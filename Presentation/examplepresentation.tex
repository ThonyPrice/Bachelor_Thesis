  ...
  \begin{columns}[T]
    ...
    \begin{column}{.5\textwidth}
      \begin{block}{}
        ...
        \begin{itemize}
          \item Feed training data\pause
          \item Allow algorithm to detect patterns\pause
          \item Train\pause
        \end{itemize}
      \end{block}
    \end{column}
...
\begin{frame}
  ...
  Cutting back on features can improve accuracy as well as speed and lessen the effort at data collection.
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}[htp]
    \centering
    \makebox[\textwidth]{
    \includegraphics[width=.3\textwidth]{images/KexDbasbild2PNG.png}
    \includegraphics[width=.3\textwidth]{images/KexFilterBildPNG.png}
    \includegraphics[width=.3\textwidth]{images/kexMLCbildPNG.png}
    }
  \end{figure}
