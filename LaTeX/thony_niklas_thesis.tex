...
\multirow{2}{*}{Feature Selection by Wrapping}
 & Sequential Feature Selector (SBS) \\
...
\hline
\end{tabular}
\caption{All feature selection methods and classifiers that will be conducted in experiments.}
\label{table:methods}
\end{center}
\end{table}

A comparison of the classification rate on the machine learning methods without using any feature selection and classification rate using feature selection will be conducted in order to establish the importance of feature selection in different machine learning approaches when classifying breast cancer. The evaluation criteria will primary be F1 score that conveys the balance between recall and precision of classification performance \parencite{muc1992}.[add more info here] Several datasets with different types of features will be evaluated. Details on the datasets will be presented in chapter \ref{sec:Datasets}
